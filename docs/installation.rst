...
The sources for JSON:API ORM can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/mislavcimpersak/jsonapi-orm
.. _tarball: https://github.com/mislavcimpersak/jsonapi-orm/tarball/master
